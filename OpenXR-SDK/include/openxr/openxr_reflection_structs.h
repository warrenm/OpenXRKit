...
#define XR_LIST_ALL_STRUCTURE_TYPES(_avail, _unavail) \
    ...
    _impl_XR_LIST_ALL_STRUCTURE_TYPES_XR_USE_GRAPHICS_API_METAL_XR_USE_PLATFORM_APPLE(_avail, _unavail) \
...
#if defined(XR_USE_GRAPHICS_API_METAL) && defined(XR_USE_PLATFORM_APPLE)
#define _impl_XR_LIST_ALL_STRUCTURE_TYPES_XR_USE_GRAPHICS_API_METAL_XR_USE_PLATFORM_APPLE(_avail, _unavail) \
