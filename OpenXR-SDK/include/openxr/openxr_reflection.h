...
#define XR_LIST_STRUCTURE_TYPES(_) \
    ...
    XR_LIST_STRUCTURE_TYPES_XR_USE_GRAPHICS_API_METAL_XR_USE_PLATFORM_APPLE(_) \
...
/// Implementation detail of XR_LIST_STRUCTURE_TYPES()
/// Structure types available only when XR_USE_GRAPHICS_API_METAL and XR_USE_PLATFORM_APPLE are defined
#define XR_LIST_STRUCTURE_TYPES_XR_USE_GRAPHICS_API_METAL_XR_USE_PLATFORM_APPLE(_) \
